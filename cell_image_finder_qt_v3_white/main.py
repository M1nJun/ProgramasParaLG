...
def apply_modern_styles(app: QApplication):
    # Fusion + a lightweight modern WHITE theme
    app.setStyle("Fusion")
    app.setStyleSheet("""
        QWidget { font-size: 12px; }
        QMainWindow { background: #f6f7fb; }
        QWidget#centralWidget { background: #f6f7fb; color: #111827; }
        ...
        QPushButton:hover { background: #2450e6; }
        QPushButton:pressed { background: #1f46cc; }
        QPushButton:disabled { background: #9aa7c7; color: #ffffff; }
        QPushButton#secondaryBtn { background: #eef1f7; color: #111827; }
        QPushButton#secondaryBtn:hover { background: #e2e7f3; }
