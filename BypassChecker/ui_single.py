...
class SinglePCWidget(QWidget):
    ...
    def _build_ui(self):
        ...
        top_row = QHBoxLayout()
        self.title_label = QLabel("This PC")
        ...
        self.filter_box.setCurrentText("Fail")  # default Fail
    ...
    def _row_brush(self, r: MeasureRow) -> QBrush | None:
        if r.is_pass:
            return QBrush(QColor(230, 255, 237))
        return QBrush(QColor(255, 235, 238))
    ...
    def export_report(self):
        if self._last_report is None:
            ...
            return
        try:
            out_path = export_report_csv(self._last_report, self.reports_dir, show_all_occurrences=True)
