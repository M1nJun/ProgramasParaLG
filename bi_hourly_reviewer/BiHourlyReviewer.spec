...
a = Analysis(
    ...
    binaries=[],
    datas=[],
    hiddenimports=['core', 'core.csv_parser', 'core.defect_filter', 'core.defect_analyzer', 'core.image_locator', 'core.image_selector', 'core.image_fetcher', 'core.fetch_pipeline', 'ui', 'ui.main_window', 'ui.fetch_tab', 'ui.review_tab', 'ui.styles', 'ui.widgets', 'ui.widgets.cell_list', 'ui.widgets.image_viewer', 'utils', 'utils.time_utils', 'utils.file_utils', 'config'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
